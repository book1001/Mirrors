...
;(function(window) {
	...
	var	currentRoom = 0,
		...
		tiltRotation = {
			...
			rotateY : 60,  // a relative rotation of -3deg to 3deg on the y-axis
      // rotateX : 1, // a relative rotation of -1deg to 1deg on the x-axis
    ...
    nextRoom.style.transform = 'translate3d(0,' + (dir === 'next' ? 100 : -100) + '%,0) translate3d(0,' + (dir === 'next' ? 1 : -1) + 'px,0)' ;
		...
		.then(function() {
			// Move left or right.
      return move({transform: { translateX : 0, translateY : (dir === 'next' ? -100 : 100) + '%', translateZ : 0, rotateX : 0, rotateY : 0, rotateZ : 0 }});
		...
		.then(function() {
      	...
      	return move({transform: { translateX : 0, translateY : (dir === 'next' ? -100 : 100) + '%', translateZ : '500px', rotateX : 0, rotateY : 0, rotateZ : 0 }});
    ...
    nextRoom.style.transform = 'translate3d(0,100%,0) translate3d(0,3px,0)';
		nextRoom.style.opacity = 1;
		prevRoom.style.transform = 'translate3d(0,-100%,0) translate3d(0,-3px,0)';
